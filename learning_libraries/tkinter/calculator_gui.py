# @task rewrite this program, and make it the best fully functional gui equipped calculator in python programming language.
...
class Calculator:
    def __init__(self, master):
        ...
        # create the input/output text box
