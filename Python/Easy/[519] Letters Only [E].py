...
Explanation of the various Python string methods.
_________
_________
join() Method
...
The Kleene star and plus allow us to match repeated characters in a line. Another quantifier that is really common when matching and extracting text is the ? (question …
_________
_________
swapcase() Method
