...
the value of the most right bit is 1,
...
## DO IT MANUALLY WILL BE AWESOME.
# NO USE OR NEED OF FUNCTIONS OR METHODS.
# Also read that functions or methods can be made manually that is use of functions or methods can be avoided?
# Use of them can be avoided altogether?

# Time your problem solving.
# Time your problem solving please.
