...
Is one of the most useful math skills you can learn. You can apply it to tips at a restaurant, sales in stores, and setting rates for your own services. The basic way t …
_________
""" 
# Your code should go here:

def getDiscount(lst1: list, str1: str) -> list:
    percentage = (int(str1.strip(%))) / 100
    i = 0
    outputLst : list
    while (i < lst1.len()):
        outputLst.append(lst1[i] * percentage)
        i = i + 1
    return outputLst

print(getDiscounts([2, 4, 6, 11], "50%")) # ➞ [1, 2, 3, 5.5]

print(getDiscounts([10, 20, 40, 80], "75%")) # ➞ [7.5, 15, 30, 60]

print(getDiscounts([100], "45%")) # ➞ [45]
