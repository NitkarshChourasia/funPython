...
Parity bits are used as very simple checksum to ensure
that binary data isn't corrupted during transit. Here's how they work:
___
...
def validateBinary(str1: str) -> bool:
    count1s = str1[0: -2].count(1)
...
print(validateBinary("00101101")) # ➞ True

print(validateBinary("11000000")) # ➞ True

print(validateBinary("11000001")) # ➞ False


# checkResources.
# testing.

# Good readability I must say, so.