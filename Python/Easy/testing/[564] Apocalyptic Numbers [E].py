...
If the number is apocalyptic, find the index of 666 in 2^n,
...
# There is a better and more efficient way of doing this.

def apocalyptic(n):
    x = str(2**n)
    if "666" in x:
        return "Repent! {0} days until the Apocalypse!".format(x.index("666"))
    elif "666" not in x:
