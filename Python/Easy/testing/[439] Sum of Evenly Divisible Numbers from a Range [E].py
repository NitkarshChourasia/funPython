...
def evenlyDivisible(start, end, pattern):
    outputAns = []
    for i in range(start - 1, end + 1, patten):
        outputAns.append(i)
    if outputAns.len() == 0:
        return 0
    else:
...
print(evenlyDivisible(1, 10, 20)) # ➞ 0
# No number between 1 and 10 can be evenly divided by 20.

print(evenlyDivisible(1, 10, 2)) # ➞ 30
# 2 + 4 + 6 + 8 + 10 = 30

print(evenlyDivisible(1, 10, 3)) # ➞ 18
# 3 + 6 + 9 = 18
