...
How can I do the following? row = [unicode(x.strip()) for x in row if x is not None else '']
Essentially: 1. Replace all the Nones with empty strings, and then ... 2. C …
_________
_________
split( ) Method
...
def specialReverse(str1):
    pass

print(specialReverse("word searches are super fun", "s"))
# ➞ "word sehcraes are repus fun"

print(specialReverse("first man to walk on the moon", "m"))
# ➞ "first nam to walk on the noom"

print(specialReverse("peter piper picked pickled peppers", "p"))
# ➞ "retep repip dekcip delkcip sreppep"
