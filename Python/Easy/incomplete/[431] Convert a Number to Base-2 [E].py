...
def binary(base10Input):
    remainingValue = base10Input % 2
    # study log method.
    # some log range.
    # let's design the bin function ourselve first.
    # study binary then attempt this.


# incomplete.
# checkAgain.
# checkAgain. Understand binary numbers and log and log functions and ways.
# This problem will be so good.
