...
[algorithms] [formatting] [logic] [strings] 
...
In Python3, ascii_uppercase is a pre-initialized string used as string constant. In Python, string ascii_uppercase will give the uppercase letters ‘ABCDEFGHIJKLMNOPQRST …
_________
_________
Python Dictionaries
...
def alphNum(str1 : str) -> str:
    pass

# I can do it. But, it would be much better if done with some standards. It will be much more effiecient too, indeed.

# incomplete.
# checkResources.
# checkResources for sure.