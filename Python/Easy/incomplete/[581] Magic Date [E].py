...
magic("9 2 2018") ➞ True # Will my program hold up to it?
_____
...
def magic(str1 : str) -> bool:
    pass

"""
Step 1: Split the strings into their individual variables.
Step 2: Convert them into int.
Step 3: Check the length of the dd ** mm.
Step 4: According to that apply the conditional statements check.
Step 5: Thus outputting the ans in boolean.
"""
