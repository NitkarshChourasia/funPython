...
def getFrequencies(lst1 : list) -> dict:
    pass

print(getFrequencies(["A", "B", "A", "A", "A"])) # ➞ { "A" : 4, "B" : 1 }

print(getFrequencies([1, 2, 3, 3, 2])) # ➞ { 1: 1, 2: 2, 3: 2 }

print(getFrequencies([True, False, True, False, False])) # ➞ { True: 2, False: 3 }
