...
*) Find more info on RegEx and character classes in the Resources tab.
...
Often shortened as regex, are a sequence of characters used to check whether a pattern exists in a given text (string) or not.
_________
_________
Online RegeEx Tester and Debugger
