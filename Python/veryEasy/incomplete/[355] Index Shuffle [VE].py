...
Write a function that takes all even-indexed characters and
...
def indexShuffle(str1):
    # why I convert into lists? Can't I convert them into strings? DIrectly?
    # instead of doing outputAns = [], can't I do something like str1 = ""


print(indexShuffle("abcdefg")) # ➞ "acegbdf"

print(indexShuffle("holiday")) # ➞ "hldyoia"

print(indexShuffle("maybe")) # ➞ "myeab"


# incomplete.
# checkAgain.
# testing.
# I use way lots of loops, which consumes ram.
