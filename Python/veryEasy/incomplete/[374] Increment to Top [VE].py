...
each element to the maximal element in the list. Each step consists of incrementing a digit by one.
...
def incrementToTop(lst1):
    i = 0
    maxInt = lst1.sorted[-1]
    for i in lst1:
        while(i == maxInt)
            i = i + 1
    return i
...
print(incrementToTop([3, 4, 5])) # ➞ 3
# Maximal element in the array is 5.
# To transform 3 to 5 requires 2 steps: 3 -> 4, 4 -> 5.
# To transform 4 to 5 requires 1 step: 4 -> 5.
# Total steps required is 3.

print(incrementToTop([4, 3, 4])) # ➞ 1
# Maximal element in the array is 4.
# To transform 3 to 4 requires 1 steps: 3 -> 4.
# Total steps required is 1.

print(incrementToTop([3, 3, 3])) # ➞ 0

print(incrementToTop([3, 10, 3])) # ➞ 14


# testing.
# checkAgain.
# checkAgain. What is meant by comprehension in python.
# incomplete.
# incomplete. Wasn't able to complete by the constraints of the notes, respectively.
