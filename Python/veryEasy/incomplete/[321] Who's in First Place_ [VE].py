...
first_place("proeNeoOJGnfl") ➞ "l"    # Isn't it's wrong by the definition provided in the notes?
_____
...
Python offers many ways to substring a string. It is often called ‘slicing’. It follows this template: string[start: end: step] Where, start: The starting index of t …
_________
_________
...
def firstPlace(road):
    if "=" not in road:
        return None
"
Steps: Remove all the "=" then,
it will be available a array of strings then,
return str1[-1] from it.

# incomplete.
# checkAgain. The resources which you don't know.
# The reason for not completing the problem is the lack of clearity for completing it.
