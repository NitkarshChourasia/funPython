...
[arrays] [conditions] [control_flow] [validation]
...
https://www.youtube.com/watch?v=aaEE4d-WaWs
Return true or false if item in list meets or doesn't meet criteria.
_________
_________
Python for Loop
...
def hurdleJump(lst1, n):
    highestNum = lst1.sort()
    if n >= highestNum:
        return True
    else:
        return False
