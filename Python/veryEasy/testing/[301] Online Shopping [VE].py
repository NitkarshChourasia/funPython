...
https://www.tutorialspoint.com/How-to-sum-values-of-a-Python-dictionary
It is pretty easy to get the sum of values of a python dictionary. You can first get the values in a list using the dict.values(). Then you can call the sum method to g …
_________
"""
# Your code should go here:


def freeShipping(dict1):
    outputAns = []
    for i in dict1:
        outputAns.append(dict1.values(i))
    return outputAns


print(freeShipping(({ "Shampoo": 5.99, "Rubber Ducks": 15.99 })) # ➞ False
print(freeShipping(({ "Flatscreen TV": 399.99 })) # ➞ True
print(freeShipping(({ "Monopoly": 11.99, "Secret Hitler": 35.99, "Bananagrams": 13.99 })) # ➞ True

# testing.
# checkAgain.
# checkAgain, iterate over dict1.
