...
print(identicalFilter(["aaaaaa", "bc", "d", "eeee", "xyz"]))
# ➞ ["aaaaaa", "d", "eeee"]

print(identicalFilter(["88", "999", "22", "545", "133"]))
# ➞ ["88", "999", "22"]

print(identicalFilter(["xxxxo", "oxo", "xox", "ooxxoo", "oxo"]))
# ➞ []
