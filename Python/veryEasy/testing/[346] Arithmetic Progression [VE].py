...
difference between the consecutive terms is constant. Create a function that takes three arguments:
___
...
[arrays] [functional_programming] [language_fundamentals] [strings]
...
A sequence of numbers such that the difference between the consecutive terms is constant. For instance, the sequence 5, 7, 9, 11, 13, 15, . . . is an arithmetic progres …
_________
_________
...
def arithmeticProgression(firstEle, diff, n):
    # lastEle should be the n.
    # lastEle should be made.

    lastEle = firstEle
    i = 0
    while(i == n)
        lastEle = firstEle + diff
        i = i + 1

    range1 = range(firstEle, LastEle + 1, diff)  # Will have to make a arithmetic sequence out of it.
    outputlist = []
    for i in range1:
        outputList.append(i)
...
print(arithmeticProgression(1, 2, 5)) # ➞ "1, 3, 5, 7, 9"
print(arithmeticProgression(1, 0, 5)) # ➞ "1, 1, 1, 1, 1"
print(arithmeticProgression(1, -3, 10)) # ➞ "1, -2, -5, -8, -11, -14, -17, -20, -23, -26"


# testing.
# checkAgain.
# checkAgain. Line 68.
# To convert list into different types of output should learn that.
