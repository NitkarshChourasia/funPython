...
Each list will consist of 3 positive integers, representing the dimensions of cuboids a and b.
...
print(findDifference([ 28, 16, 29 ], [ 7, 8, 17 ]))
print(findDifference([ 9, 22, 18 ], [ 16, 24, 10 ]))
print(findDifference([ 1, 9, 25 ], [ 10, 7, 9 ]))
print(findDifference([ 7, 6, 16 ], [ 26, 9, 26 ]))

# What is cuboid???
# testing.
# checkAgain.
# check the proper functioning of all the new features.
