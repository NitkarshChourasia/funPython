...
print(checkAllEven([1, 2, 3, 4])) # ➞ False
print(checkAllEven([2, 4, 6])) # ➞ True
print(checkAllEven([5, 6, 8, 10])) # ➞ False
print(checkAllEven([-2, 2, -2, 2])) # ➞ True


# testing.
# checkAgain. Consumes lots of memory, make a one that consumes memory equivalent to None.
