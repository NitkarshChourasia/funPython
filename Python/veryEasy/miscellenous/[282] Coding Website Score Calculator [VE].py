...
def scoreCalculator(easy, medium, hard):
    if easy and medium and hard < 0:
        return "Invalid passed parameters."
    else:
        finalOutput = easy * 5 + medium * 10 + hard * 20
        return finalOutput



print(scoreCalculator((1, 2, 3)) # ➞ 85
print(scoreCalculator((1, 0, 10)) # ➞ 205
print(scoreCalculator((5, 2, -6)) # ➞ "invalid"
