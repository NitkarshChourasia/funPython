...
_________
range() Function
https://www.pythoncentral.io/pythons-range-function-explained/#:~:text=range()%20(and%20Python%20in,%2C%20but%20not%20including%2C%20stop%20.
It's usage, along with an explanation about xrange(). Their differences, and how to use range() with floats!
_________
_________
append() Method
