...
_________
_________
How to find the sum of a given range of integers in Python?
https://www.quora.com/How-do-you-find-the-sum-of-a-given-range-of-integers-in-python
...
def addOddToN(num1):
    range1  = (1, n+1, 2)
    return range1.sum() # if doesn't work make a list of it.

# How to make a list without using for.

print(addOdd_to_n(5)) # ➞ 9
# 1 + 3 + 5 = 9
print(addOdd_to_n(13)) # ➞ 49
print(addOdd_to_n(47)) # ➞ 576
