...
_________
_________
Using the split() Method to Count Words in a String
https://www.youtube.com/watch?v=hAd2pG9cgBw
Shows how using split() allows the words in a sentence to be counted.
_________
"""
...
def countWords(str1):
    outputAns = [str1.split(" ")]
    return outputAns.len()


print(countWords(("Just an example here move along")) # ➞ 6
print(countWords(("This is a test")) # ➞ 4
print(countWords(("What an easy task, right")) # ➞ 5
