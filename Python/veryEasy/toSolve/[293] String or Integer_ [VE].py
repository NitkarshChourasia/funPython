...
Python supports object-oriented programming and hence classes can be created using python. Sometimes, it is essential to know mid-program that which objects belong to w …
_________
_________
type() Method
...
_________
_________
Introduction to Python's type() Method
...
def intOrStr(input1):
    if input1 == isinstance(int):
        return "Int."
    elif input1 == isinstance(string):
        return "String."
    else:
        return "Not specified type."


print(intOrString((8)) # ➞ "int"
print(intOrString(("Hello")) # ➞ "str"
print(intOrString((9843532)) # ➞ "int"
