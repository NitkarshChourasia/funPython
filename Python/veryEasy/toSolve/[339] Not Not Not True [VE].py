...
The Boolean data type can be one of two values, either True or False. We use Booleans in programming to make comparisons and to control the flow of the program. Boolean …
_________
_________
eval() Method
...
print(notNotNot(1, True)) # ➞ False
# Not True.
print(notNotNot(2, False)) # ➞ False
# Not not False.
print(notNotNot(6, True)) # ➞ True
# Not not not not not not True.
