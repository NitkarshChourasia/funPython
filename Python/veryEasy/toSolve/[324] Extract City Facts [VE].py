...
Create a function that takes a dictionary as an argument and returns a string with facts about the city.
The city facts will need to be extracted from the dictionaries three properties:
...
We're going to learn about mappings in Python. If you're familiar with other languages you can think of these Dictionaries as hash tables.
_________
_________
values() Method
...
Lets you concatenate elements within a string through positional formatting.
_________
"""
...
def cityFacts(dict1):
    return "{0} has a population of {1} and is situated in {2}"
