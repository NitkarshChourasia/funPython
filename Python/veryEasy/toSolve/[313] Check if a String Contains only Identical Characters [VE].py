...
To find whether string has all the same characters. Traverse the whole string from index 1 and check whether that character matches with first character of string or no …
_________
"""
# Your code should go here:


def isIdentical(str1):
    outputAns = set(str1)
    if str1.len() == 1:
        return True
    else:
...
print(isIdentical("aaaaaa")) # ➞ True
print(isIdentical("aabaaa")) # ➞ False
print(isIdentical("ccccca")) # ➞ False
print(isIdentical("kk")) # ➞ True
