...
This has to do with the fact that in sets order doesn't matter, so that Python considers {8, 1, 2, 4} and {1, 2, 4, 8} to be the same set.
*) In the test cases you won't have to worry about orders:
the answers will always have the order given by applying the list(), tuple(), set() functions.
___
...
print(convert(([1, 2, 4, 8], (7, 8, 9))) # ➞ [7, 8, 9]
print(convert(((7, 8, 9), [1, 2, 4, 8])) # ➞ (1, 2, 4, 8)
print(convert(([1, 2, 4, 8], {2, 3, 5, 7, 11, 13})) # ➞ [2, 3, 5, 7, 11, 13]
print(convert(({2, 3, 5, 7, 11, 13}, [1, 2, 4, 8])) # ➞ {8, 1, 2, 4}
