...
The insurance guy calls again.
Apparently, they were informed by your spouse that some items were not stolen at all and you failed to mention this detail to them.
This is a fraud attempt! You freeze and mumble something unintelligible. Find out what you said.
Given a dictionary, return a string that concatenates all the values and adds the 2nd key at the end.
...
def burglarySeries(dict1):
    outputAns = dict1 + getvalue(2)
    return outputAns


print(burglarySeries({ 1: "Mommy", 2: "please", 3: "help" })) # ➞ "Mommy please help please"
print(burglarySeries({ 1: "Me", 2: "innocent", 3: "is" })) # ➞ "Me innocent is innocent"
print(burglarySeries({ 1: "Must", 2: "lawyer", 3: "call" })) # ➞ "Must lawyer call lawyer"
