...
def firstLastConcat(str1):
    return str1[1] + str[-1]


print(firstLastConcat("shiva"))
print(firstLastConcat("vishnu"))
print(firstLastConcat("ganesh"))
print(firstLastConcat("parvati"))
print(firstLastConcat("kali"))

# testing.
# Can Improve the code further.
    # By introduction "empty str" function and a .lower() function.
