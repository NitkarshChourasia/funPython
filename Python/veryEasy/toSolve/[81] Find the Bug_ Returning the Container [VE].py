...
The packaging system is running wild! The candy is lying loose all over in the warehouse,
the cereal is missing, and bread is stuffed in a bottle.
...
def getContainer(str1):
    packSys = {bread : bag, beer : bottle, candy : plastic, cheese : }
    str1 = str1.lower()
    getValue
    return Value

# What if there is present none in it?
