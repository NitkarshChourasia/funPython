...
For instance, if ABBACCCCAC is written when the game is over,
then Andy scored 3 points, Ben scored 2 points,
and Charlotte scored 5 points,
since there are 3 instances of letter A, 2 instances of letter B, and 5 instances
of letter C. So the list [3, 2, 5] should be returned.
...
print(calculateScores("A")) # ➞ [1, 0, 0]
print(calculateScores("ABC")) # ➞ [1, 1, 1]
print(calculateScores("ABCBACC")) # ➞ [2, 2, 3]
