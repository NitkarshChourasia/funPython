...
Can someone explain to me why the first code block doesn't change the list, but the second does. a = [1,2,3] for el in a: el += 5 This leaves a as [1,2,3]. That sa …
_________
_________
