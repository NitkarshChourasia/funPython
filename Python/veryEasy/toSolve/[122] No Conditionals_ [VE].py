...
A logical operator in Python that will return True if the expression is False. The "not" operator is used in the if statements.
_________
_________
How to convert integer into digit list?
