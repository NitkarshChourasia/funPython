...
print(filterDigitLength([88, 232, 4, 9721, 555], 3)) # ➞ [232, 555]
# Include only numbers with 3 digits.
print(filterDigitLength([2, 7, 8, 9, 1012], 1)) # ➞ [2, 7, 8, 9]
# Include only numbers with 1 digit.
print(filterDigitLength([32, 88, 74, 91, 300, 4050], 1)) # ➞ []
# No numbers with only 1 digit exist => return empty list.
print(filterDigitLength([5, 6, 8, 9], 1)) # ➞ [5, 6, 8, 9]
# All numbers in the list have 1 digit only => return original list.
