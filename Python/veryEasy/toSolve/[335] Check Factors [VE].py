...
Demonstrates a simple method for factoring numbers. Also explains the usefulness of prime factorization. "Factors" are the numbers you multiply to get another number. F …
_________
"""
# Your code should go here:


def checkFactor(lst1, m):
    lst2 = []
    for i in lst1:
        if n % i == 0:
            lst2.append(i)
...
print(checkFactors([2, 3, 4], 12)) # ➞ True
# Since 2, 3, and 4 are all factors of 12.
print(checkFactors([1, 2, 3, 8], 12)) ➞ False
# 8 is not a factor of 12.
print(checkFactors([1, 2, 50], 100)) ➞ True
print(checkFactors([3, 6], 9)) ➞ False
