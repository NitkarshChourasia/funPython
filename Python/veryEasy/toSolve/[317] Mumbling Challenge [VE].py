...
_________
capitalize() Method
https://www.geeksforgeeks.org/string-capitalize-python/#:~:text=In%20Python%2C%20the%20capitalize(),in%20the%20string%20lowercase%20letters.
Returns a copy of the original string and converts the first character of the string to a capital (uppercase) letter while making all other characters in the string low …
_________
"""
...
def mumbling(str1):
    lst1 = []
    for i in str1:
        multiply1 = str1.index(i, 1)
        lst1.append(capitalize(i))
        lst1.append(i * multiply1 -1)
    return lst1.join("-")
...
print(mumbling("MubAshIr")) # ➞ "M-Uu-Bbb-Aaaa-Sssss-Hhhhhh-Iiiiiii-Rrrrrrrr"
print(mumbling("maTT")) # ➞ "M-Aa-Ttt-Tttt"
print(mumbling("EdaBit")) # ➞ "E-Dd-Aaa-Bbbb-Iiiii-Tttttt"
