...
def measure_ram_usage(function, *args):
    ...
    before_ram = process.memory_info().rss / (1024 * 1024)  # RAM usage before function call (in MB)
    result = function(*args)
    after_ram = process.memory_info().rss / (1024 * 1024)  # RAM usage after function call (in MB)
...
if __name__ == "__main__":
    ...
    # Using generator
    generator_result, generator_ram_usage = measure_ram_usage(generate_numbers_with_generator, total_numbers)
    ...
    for_loop_result, for_loop_ram_usage = measure_ram_usage(generate_numbers_with_for_loop, total_numbers)
